//Создаем структуру с информацией о стране. 
...
void ParseCitySubjson(vector<City>& cities, const Json& json, const CountryInformation& country) {
...
void ParseCountryJson(vector<Country>& countries, vector<City>& cities, const Json& json) {
    for (const auto& country_json : json.AsList()) {
        ...
        //При вызове функции заполняем CountryInformation с помошью designated initializers 
        ParseCitySubjson(cities, country_obj["cities"s], CountryInformation{
